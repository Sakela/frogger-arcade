...
var Engine = (function(global) {
    ...
    function main() {
         ...
         */
         if( player.sprite !== undefined ){update(dt);
         render();}
    ...
    function reset() {
        ...
        var charImage, list, header, article, artImg;

        list = document.createElement("DIV");
        header = document.createElement("H1");

        header.className += "darkgray-white-center";
        list.appendChild(header);
        header.innerHTML = "Choose Your Character";
        document.body.insertBefore(list, canvas);

        article = document.createElement("ARTICLE");
        article.innerHTML = "To move the character on the screen use keyboard arrows as shown in the image below. The goal is to avoid bugs (they take your score down to 0) and reach the water (to get 1 point). If you are lucky enough you can get random loot (such as heart, key or gems) that will add 3 points each time you catch one";
        artImg = document.createElement("IMG");
        artImg.setAttribute("src", "images/keyboard.png");
        article.className += "darkgray-white-center";
